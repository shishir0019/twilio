...
// node_modules/@twilio/voice-sdk/es5/twilio/backoff.js
var require_backoff = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/backoff.js"(exports) {
    "use strict";
    ...
    var Backoff = (
      ...
      (function(_super) {
        ...
        Backoff2.prototype.backoff = function() {
          var _this = this;
...
// node_modules/@twilio/voice-sdk/es5/twilio/errors/twilioError.js
var require_twilioError = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/errors/twilioError.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ (function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var TwilioError = (
      ...
      (function(_super) {
        ...
        function TwilioError2(messageOrError, error) {
          var _this = _super.call(this) || this;
          Object.setPrototypeOf(_this, TwilioError2.prototype);
          var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
          var originalError = typeof messageOrError === "object" ? messageOrError : error;
...
// node_modules/@twilio/voice-sdk/es5/twilio/errors/generated.js
var require_generated = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/errors/generated.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ (function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var twilioError_1 = require_twilioError();
    ...
    (function(AuthorizationErrors2) {
      var AccessTokenInvalid = (
        /** @class */
        (function(_super) {
          __extends(AccessTokenInvalid2, _super);
          function AccessTokenInvalid2(messageOrError, error) {
            ...
            _this.solutions = [];
            Object.setPrototypeOf(_this, AuthorizationErrors2.AccessTokenInvalid.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
      ...
      var AccessTokenExpired = (
        /** @class */
        (function(_super) {
          __extends(AccessTokenExpired2, _super);
          function AccessTokenExpired2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [];
            _this.code = 20104;
            ...
            _this.solutions = [];
            Object.setPrototypeOf(_this, AuthorizationErrors2.AccessTokenExpired.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
      ...
      var AuthenticationFailed = (
        /** @class */
        (function(_super) {
          __extends(AuthenticationFailed2, _super);
          function AuthenticationFailed2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [];
            _this.code = 20151;
            ...
            _this.solutions = [];
            Object.setPrototypeOf(_this, AuthorizationErrors2.AuthenticationFailed.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
    ...
    (function(SignatureValidationErrors2) {
      var AccessTokenSignatureValidationFailed = (
        /** @class */
        (function(_super) {
          __extends(AccessTokenSignatureValidationFailed2, _super);
          function AccessTokenSignatureValidationFailed2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [
            ...
            Object.setPrototypeOf(_this, SignatureValidationErrors2.AccessTokenSignatureValidationFailed.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
          ...
          return AccessTokenSignatureValidationFailed2;
        })(twilioError_1.default)
      );
    ...
    (function(ClientErrors2) {
      var BadRequest = (
        /** @class */
        (function(_super) {
          __extends(BadRequest2, _super);
          function BadRequest2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [];
            _this.code = 31400;
            ...
            _this.solutions = [];
            Object.setPrototypeOf(_this, ClientErrors2.BadRequest.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
      ...
      var NotFound = (
        /** @class */
        (function(_super) {
          __extends(NotFound2, _super);
          function NotFound2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [
            ...
            Object.setPrototypeOf(_this, ClientErrors2.NotFound.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
      ...
      var TemporarilyUnavailable = (
        /** @class */
        (function(_super) {
          __extends(TemporarilyUnavailable2, _super);
          function TemporarilyUnavailable2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [];
            _this.code = 31480;
            ...
            _this.solutions = [];
            Object.setPrototypeOf(_this, ClientErrors2.TemporarilyUnavailable.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
          ...
          return TemporarilyUnavailable2;
        })(twilioError_1.default)
      );
      ...
      var BusyHere = (
        /** @class */
        (function(_super) {
          __extends(BusyHere2, _super);
          function BusyHere2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [];
            _this.code = 31486;
            ...
            _this.name = "BusyHere";
            _this.solutions = [];
            Object.setPrototypeOf(_this, ClientErrors2.BusyHere.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
    ...
    (function(SIPServerErrors2) {
      var Decline = (
        /** @class */
        (function(_super) {
          __extends(Decline2, _super);
          function Decline2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [];
            _this.code = 31603;
            ...
            _this.name = "Decline";
            _this.solutions = [];
            Object.setPrototypeOf(_this, SIPServerErrors2.Decline.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
    ...
    (function(GeneralErrors2) {
      var UnknownError = (
        ...
        (function(_super) {
          ...
          function UnknownError2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [];
            _this.code = 31e3;
            ...
            _this.solutions = [];
            Object.setPrototypeOf(_this, GeneralErrors2.UnknownError.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
      ...
      var ApplicationNotFoundError = (
        /** @class */
        (function(_super) {
          __extends(ApplicationNotFoundError2, _super);
          function ApplicationNotFoundError2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [];
            _this.code = 31001;
            ...
            _this.solutions = [];
            Object.setPrototypeOf(_this, GeneralErrors2.ApplicationNotFoundError.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
          ...
          return ApplicationNotFoundError2;
        })(twilioError_1.default)
      );
      GeneralErrors2.ApplicationNotFoundError = ApplicationNotFoundError;
      var ConnectionDeclinedError = (
        /** @class */
        (function(_super) {
          __extends(ConnectionDeclinedError2, _super);
          function ConnectionDeclinedError2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [];
            _this.code = 31002;
            ...
            _this.solutions = [];
            Object.setPrototypeOf(_this, GeneralErrors2.ConnectionDeclinedError.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
          ...
          return ConnectionDeclinedError2;
        })(twilioError_1.default)
      );
      ...
      var ConnectionTimeoutError = (
        /** @class */
        (function(_super) {
          __extends(ConnectionTimeoutError2, _super);
          function ConnectionTimeoutError2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [];
            _this.code = 31003;
            ...
            _this.solutions = [];
            Object.setPrototypeOf(_this, GeneralErrors2.ConnectionTimeoutError.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
          ...
          return ConnectionTimeoutError2;
        })(twilioError_1.default)
      );
      ...
      var ConnectionError = (
        ...
        (function(_super) {
          ...
          function ConnectionError2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [];
            _this.code = 31005;
            ...
            _this.solutions = [];
            Object.setPrototypeOf(_this, GeneralErrors2.ConnectionError.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
      ...
      var CallCancelledError = (
        /** @class */
        (function(_super) {
          __extends(CallCancelledError2, _super);
          function CallCancelledError2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [
            ...
            _this.solutions = [];
            Object.setPrototypeOf(_this, GeneralErrors2.CallCancelledError.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
      ...
      var TransportError = (
        ...
        (function(_super) {
          ...
          function TransportError2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [];
            _this.code = 31009;
            ...
            _this.solutions = [];
            Object.setPrototypeOf(_this, GeneralErrors2.TransportError.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
    ...
    (function(MalformedRequestErrors2) {
      var MalformedRequestError = (
        /** @class */
        (function(_super) {
          __extends(MalformedRequestError2, _super);
          function MalformedRequestError2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [
            ...
            Object.setPrototypeOf(_this, MalformedRequestErrors2.MalformedRequestError.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
          ...
          return MalformedRequestError2;
        })(twilioError_1.default)
      );
      MalformedRequestErrors2.MalformedRequestError = MalformedRequestError;
      var MissingParameterArrayError = (
        /** @class */
        (function(_super) {
          __extends(MissingParameterArrayError2, _super);
          function MissingParameterArrayError2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [];
            _this.code = 31101;
            ...
            _this.solutions = [];
            Object.setPrototypeOf(_this, MalformedRequestErrors2.MissingParameterArrayError.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
          ...
          return MissingParameterArrayError2;
        })(twilioError_1.default)
      );
      MalformedRequestErrors2.MissingParameterArrayError = MissingParameterArrayError;
      var AuthorizationTokenMissingError = (
        /** @class */
        (function(_super) {
          __extends(AuthorizationTokenMissingError2, _super);
          function AuthorizationTokenMissingError2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [];
            _this.code = 31102;
            ...
            _this.solutions = [];
            Object.setPrototypeOf(_this, MalformedRequestErrors2.AuthorizationTokenMissingError.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
          ...
          return AuthorizationTokenMissingError2;
        })(twilioError_1.default)
      );
      MalformedRequestErrors2.AuthorizationTokenMissingError = AuthorizationTokenMissingError;
      var MaxParameterLengthExceededError = (
        /** @class */
        (function(_super) {
          __extends(MaxParameterLengthExceededError2, _super);
          function MaxParameterLengthExceededError2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [];
            _this.code = 31103;
            ...
            _this.solutions = [];
            Object.setPrototypeOf(_this, MalformedRequestErrors2.MaxParameterLengthExceededError.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
          ...
          return MaxParameterLengthExceededError2;
        })(twilioError_1.default)
      );
      MalformedRequestErrors2.MaxParameterLengthExceededError = MaxParameterLengthExceededError;
      var InvalidBridgeTokenError = (
        /** @class */
        (function(_super) {
          __extends(InvalidBridgeTokenError2, _super);
          function InvalidBridgeTokenError2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [];
            _this.code = 31104;
            ...
            _this.solutions = [];
            Object.setPrototypeOf(_this, MalformedRequestErrors2.InvalidBridgeTokenError.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
          ...
          return InvalidBridgeTokenError2;
        })(twilioError_1.default)
      );
      MalformedRequestErrors2.InvalidBridgeTokenError = InvalidBridgeTokenError;
      var InvalidClientNameError = (
        /** @class */
        (function(_super) {
          __extends(InvalidClientNameError2, _super);
          function InvalidClientNameError2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [
            ...
            Object.setPrototypeOf(_this, MalformedRequestErrors2.InvalidClientNameError.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
          ...
          return InvalidClientNameError2;
        })(twilioError_1.default)
      );
      MalformedRequestErrors2.InvalidClientNameError = InvalidClientNameError;
      var ReconnectParameterInvalidError = (
        /** @class */
        (function(_super) {
          __extends(ReconnectParameterInvalidError2, _super);
          function ReconnectParameterInvalidError2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [];
            _this.code = 31107;
            ...
            _this.solutions = [];
            Object.setPrototypeOf(_this, MalformedRequestErrors2.ReconnectParameterInvalidError.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
          ...
          return ReconnectParameterInvalidError2;
        })(twilioError_1.default)
      );
    ...
    (function(AuthorizationErrors2) {
      var AuthorizationError = (
        /** @class */
        (function(_super) {
          __extends(AuthorizationError2, _super);
          function AuthorizationError2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [];
            _this.code = 31201;
            ...
            _this.solutions = [];
            Object.setPrototypeOf(_this, AuthorizationErrors2.AuthorizationError.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
          ...
          return AuthorizationError2;
        })(twilioError_1.default)
      );
      AuthorizationErrors2.AuthorizationError = AuthorizationError;
      var NoValidAccountError = (
        /** @class */
        (function(_super) {
          __extends(NoValidAccountError2, _super);
          function NoValidAccountError2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [];
            _this.code = 31203;
            ...
            _this.solutions = [];
            Object.setPrototypeOf(_this, AuthorizationErrors2.NoValidAccountError.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
          ...
          return NoValidAccountError2;
        })(twilioError_1.default)
      );
      AuthorizationErrors2.NoValidAccountError = NoValidAccountError;
      var InvalidJWTTokenError = (
        /** @class */
        (function(_super) {
          __extends(InvalidJWTTokenError2, _super);
          function InvalidJWTTokenError2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [];
            _this.code = 31204;
            ...
            _this.solutions = [];
            Object.setPrototypeOf(_this, AuthorizationErrors2.InvalidJWTTokenError.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
          ...
          return InvalidJWTTokenError2;
        })(twilioError_1.default)
      );
      AuthorizationErrors2.InvalidJWTTokenError = InvalidJWTTokenError;
      var JWTTokenExpiredError = (
        /** @class */
        (function(_super) {
          __extends(JWTTokenExpiredError2, _super);
          function JWTTokenExpiredError2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [];
            _this.code = 31205;
            ...
            _this.solutions = [];
            Object.setPrototypeOf(_this, AuthorizationErrors2.JWTTokenExpiredError.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
          ...
          return JWTTokenExpiredError2;
        })(twilioError_1.default)
      );
      AuthorizationErrors2.JWTTokenExpiredError = JWTTokenExpiredError;
      var RateExceededError = (
        /** @class */
        (function(_super) {
          __extends(RateExceededError2, _super);
          function RateExceededError2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [
              "Rate limit exceeded."
            ];
            ...
            Object.setPrototypeOf(_this, AuthorizationErrors2.RateExceededError.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
          ...
          return RateExceededError2;
        })(twilioError_1.default)
      );
      AuthorizationErrors2.RateExceededError = RateExceededError;
      var JWTTokenExpirationTooLongError = (
        /** @class */
        (function(_super) {
          __extends(JWTTokenExpirationTooLongError2, _super);
          function JWTTokenExpirationTooLongError2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [];
            _this.code = 31207;
            ...
            _this.solutions = [];
            Object.setPrototypeOf(_this, AuthorizationErrors2.JWTTokenExpirationTooLongError.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
          ...
          return JWTTokenExpirationTooLongError2;
        })(twilioError_1.default)
      );
      AuthorizationErrors2.JWTTokenExpirationTooLongError = JWTTokenExpirationTooLongError;
      var ReconnectAttemptError = (
        /** @class */
        (function(_super) {
          __extends(ReconnectAttemptError2, _super);
          function ReconnectAttemptError2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [];
            _this.code = 31209;
            ...
            _this.solutions = [];
            Object.setPrototypeOf(_this, AuthorizationErrors2.ReconnectAttemptError.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
          ...
          return ReconnectAttemptError2;
        })(twilioError_1.default)
      );
      AuthorizationErrors2.ReconnectAttemptError = ReconnectAttemptError;
      var CallMessageEventTypeInvalidError = (
        /** @class */
        (function(_super) {
          __extends(CallMessageEventTypeInvalidError2, _super);
          function CallMessageEventTypeInvalidError2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [
            ...
            Object.setPrototypeOf(_this, AuthorizationErrors2.CallMessageEventTypeInvalidError.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
          ...
          return CallMessageEventTypeInvalidError2;
        })(twilioError_1.default)
      );
      AuthorizationErrors2.CallMessageEventTypeInvalidError = CallMessageEventTypeInvalidError;
      var PayloadSizeExceededError = (
        /** @class */
        (function(_super) {
          __extends(PayloadSizeExceededError2, _super);
          function PayloadSizeExceededError2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [
            ...
            Object.setPrototypeOf(_this, AuthorizationErrors2.PayloadSizeExceededError.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
          ...
          return PayloadSizeExceededError2;
        })(twilioError_1.default)
      );
    ...
    (function(UserMediaErrors2) {
      var PermissionDeniedError = (
        /** @class */
        (function(_super) {
          __extends(PermissionDeniedError2, _super);
          function PermissionDeniedError2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [
            ...
            Object.setPrototypeOf(_this, UserMediaErrors2.PermissionDeniedError.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
          ...
          return PermissionDeniedError2;
        })(twilioError_1.default)
      );
      UserMediaErrors2.PermissionDeniedError = PermissionDeniedError;
      var AcquisitionFailedError = (
        /** @class */
        (function(_super) {
          __extends(AcquisitionFailedError2, _super);
          function AcquisitionFailedError2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [
            ...
            Object.setPrototypeOf(_this, UserMediaErrors2.AcquisitionFailedError.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
          ...
          return AcquisitionFailedError2;
        })(twilioError_1.default)
      );
    ...
    (function(SignalingErrors2) {
      var ConnectionError = (
        ...
        (function(_super) {
          ...
          function ConnectionError2(messageOrError, error) {
            ...
            _this.name = "ConnectionError";
            _this.solutions = [];
            Object.setPrototypeOf(_this, SignalingErrors2.ConnectionError.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
      ...
      var ConnectionDisconnected = (
        /** @class */
        (function(_super) {
          __extends(ConnectionDisconnected2, _super);
          function ConnectionDisconnected2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [
            ...
            Object.setPrototypeOf(_this, SignalingErrors2.ConnectionDisconnected.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
          ...
          return ConnectionDisconnected2;
        })(twilioError_1.default)
      );
    ...
    (function(MediaErrors2) {
      var ClientLocalDescFailed = (
        /** @class */
        (function(_super) {
          __extends(ClientLocalDescFailed2, _super);
          function ClientLocalDescFailed2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [
            ...
            Object.setPrototypeOf(_this, MediaErrors2.ClientLocalDescFailed.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
      ...
      var ClientRemoteDescFailed = (
        /** @class */
        (function(_super) {
          __extends(ClientRemoteDescFailed2, _super);
          function ClientRemoteDescFailed2(messageOrError, error) {
            var _this = _super.call(this, messageOrError, error) || this;
            _this.causes = [
              "The Client may not be using a supported WebRTC implementation.",
            ...
            Object.setPrototypeOf(_this, MediaErrors2.ClientRemoteDescFailed.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
          ...
          return ClientRemoteDescFailed2;
        })(twilioError_1.default)
      );
      ...
      var ConnectionError = (
        ...
        (function(_super) {
          ...
          function ConnectionError2(messageOrError, error) {
            ...
            Object.setPrototypeOf(_this, MediaErrors2.ConnectionError.prototype);
            var message = typeof messageOrError === "string" ? messageOrError : _this.explanation;
            var originalError = typeof messageOrError === "object" ? messageOrError : error;
            _this.message = "".concat(_this.name, " (").concat(_this.code, "): ").concat(message);
            _this.originalError = originalError;
    ...
    exports.errorsByCode = /* @__PURE__ */ new Map([
...
// node_modules/@twilio/voice-sdk/es5/twilio/errors/index.js
var require_errors = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/errors/index.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ (function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    Object.defineProperty(exports, "AuthorizationErrors", { enumerable: true, get: function() {
      return generated_1.AuthorizationErrors;
    } });
    Object.defineProperty(exports, "ClientErrors", { enumerable: true, get: function() {
      return generated_1.ClientErrors;
    } });
    Object.defineProperty(exports, "GeneralErrors", { enumerable: true, get: function() {
      return generated_1.GeneralErrors;
    } });
    Object.defineProperty(exports, "MalformedRequestErrors", { enumerable: true, get: function() {
      return generated_1.MalformedRequestErrors;
    } });
    Object.defineProperty(exports, "MediaErrors", { enumerable: true, get: function() {
      return generated_1.MediaErrors;
    } });
    Object.defineProperty(exports, "SignalingErrors", { enumerable: true, get: function() {
      return generated_1.SignalingErrors;
    } });
    Object.defineProperty(exports, "SignatureValidationErrors", { enumerable: true, get: function() {
      return generated_1.SignatureValidationErrors;
    } });
    Object.defineProperty(exports, "SIPServerErrors", { enumerable: true, get: function() {
      return generated_1.SIPServerErrors;
    } });
    Object.defineProperty(exports, "TwilioError", { enumerable: true, get: function() {
      return generated_1.TwilioError;
    } });
    Object.defineProperty(exports, "UserMediaErrors", { enumerable: true, get: function() {
    ...
    var InvalidArgumentError = (
      /** @class */
      (function(_super) {
        __extends(InvalidArgumentError2, _super);
...
// node_modules/@twilio/voice-sdk/es5/twilio/constants.js
var require_constants = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/constants.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@twilio/voice-sdk/es5/twilio/log.js
var require_log = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/log.js"(exports) {
    "use strict";
    ...
    var LogLevelModule = require_loglevel();
    var constants_1 = require_constants();
    var Log = (
      /** @class */
      (function() {
        function Log2(tag, options) {
          this._log = Log2.getLogLevelInstance(options);
          this._prefix = "[TwilioVoice][".concat(tag, "]");
        }
        Log2.getLogLevelInstance = function(options) {
          if (!Log2.loglevelInstance) {
            try {
              Log2.loglevelInstance = (options && options.LogLevelModule ? options.LogLevelModule : LogLevelModule).getLogger(constants_1.PACKAGE_NAME);
            } catch (_a) {
              console.warn("Cannot create custom logger");
              Log2.loglevelInstance = console;
            }
          }
          return Log2.loglevelInstance;
        };
        ...
        Log2.prototype.setDefaultLevel = function(level) {
        ...
        Log2.levels = LogLevelModule.levels;
        return Log2;
      })()
    );
...
// node_modules/@twilio/voice-sdk/es5/twilio/outputdevicecollection.js
var require_outputdevicecollection = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/outputdevicecollection.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var constants_1 = require_constants();
    ...
    var OutputDeviceCollection = (
      /** @class */
      (function() {
        function OutputDeviceCollection2(_name, _availableDevices, _beforeChange, _isSupported) {
          this._name = _name;
        ...
        OutputDeviceCollection2.prototype.delete = function(device) {
        ...
        OutputDeviceCollection2.prototype.get = function() {
          return this._activeDevices;
        };
        OutputDeviceCollection2.prototype.set = function(deviceIdOrIds) {
          var _this = this;
        ...
        OutputDeviceCollection2.prototype.test = function(soundUrl) {
          if (soundUrl === void 0) {
        ...
        return OutputDeviceCollection2;
      })()
    );
...
// node_modules/@twilio/voice-sdk/es5/twilio/shims/mediadeviceinfo.js
var require_mediadeviceinfo = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/shims/mediadeviceinfo.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var MediaDeviceInfoShim = (
      /** @class */
      /* @__PURE__ */ (function() {
        function MediaDeviceInfoShim2(options) {
          Object.defineProperties(this, {
            deviceId: { get: function() {
              return options.deviceId;
            } },
            groupId: { get: function() {
...
// node_modules/@twilio/voice-sdk/es5/twilio/util.js
var require_util = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/util.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function isChrome(window2, navigator2) {
      var isCriOS = !!navigator2.userAgent.match("CriOS");
      var isHeadlessChrome = !!navigator2.userAgent.match("HeadlessChrome");
      var isGoogle = typeof window2.chrome !== "undefined" && navigator2.vendor === "Google Inc." && navigator2.userAgent.indexOf("OPR") === -1 && navigator2.userAgent.indexOf("Edge") === -1;
    ...
    function isUnifiedPlanDefault(window2, navigator2, PeerConnection, RtpTransceiver) {
      if (typeof window2 === "undefined" || typeof navigator2 === "undefined" || typeof PeerConnection === "undefined" || typeof RtpTransceiver === "undefined" || typeof PeerConnection.prototype === "undefined" || typeof RtpTransceiver.prototype === "undefined") {
        return false;
      }
      if (isChrome(window2, navigator2) && PeerConnection.prototype.addTransceiver) {
      ...
      } else if (isFirefox(navigator2)) {
        return true;
      } else if (isSafari(navigator2)) {
    ...
    function sortByMimeTypes(codecs, preferredOrder) {
      var preferredCodecs = preferredOrder.map(function(codec) {
        return "audio/" + codec.toLowerCase();
      });
...
// node_modules/@twilio/voice-sdk/es5/twilio/audiohelper.js
var require_audiohelper = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/audiohelper.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ (function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var errors_1 = require_errors();
    var log_1 = require_log();
    var outputdevicecollection_1 = require_outputdevicecollection();
    var mediadeviceinfo_1 = require_mediadeviceinfo();
    ...
    var AudioHelper = (
      /** @class */
      (function(_super) {
        __extends(AudioHelper2, _super);
        function AudioHelper2(onActiveOutputsChanged, onActiveInputChanged, options) {
          var _a;
          var _this = _super.call(this) || this;
          _this.availableInputDevices = /* @__PURE__ */ new Map();
          _this.availableOutputDevices = /* @__PURE__ */ new Map();
          ...
          if (navigator && navigator.permissions && typeof navigator.permissions.query === "function") {
            navigator.permissions.query({ name: "microphone" }).then(function(microphonePermissionStatus) {
              ...
              return _this._log.warn("Warning: unable to listen for microphone permission changes. ".concat(reason));
            });
          } else {
        ...
        Object.defineProperty(AudioHelper2.prototype, "audioConstraints", {
          /**
        ...
        Object.defineProperty(AudioHelper2.prototype, "inputDevice", {
          /**
        ...
        Object.defineProperty(AudioHelper2.prototype, "inputStream", {
          /**
        ...
        Object.defineProperty(AudioHelper2.prototype, "processedStream", {
          /**
        ...
        AudioHelper2.prototype._destroy = function() {
        ...
        AudioHelper2.prototype._getInputDevicePromise = function() {
          return this._inputDevicePromise;
        };
        AudioHelper2.prototype._maybeStartPollingVolume = function() {
          var _this = this;
        ...
        AudioHelper2.prototype._maybeStopPollingVolume = function() {
        ...
        AudioHelper2.prototype._openDefaultDeviceWithConstraints = function(constraints) {
          var _this = this;
        ...
        AudioHelper2.prototype._stopDefaultInputDeviceStream = function() {
        ...
        AudioHelper2.prototype._unbind = function() {
          var _a;
          if ((_a = this._mediaDevices) === null || _a === void 0 ? void 0 : _a.removeEventListener) {
            this._mediaDevices.removeEventListener("devicechange", this._updateAvailableDevices);
          }
        };
        AudioHelper2.prototype._updateUserOptions = function(options) {
        ...
        AudioHelper2.prototype.addProcessor = function(processor) {
        ...
        AudioHelper2.prototype.setAudioConstraints = function(audioConstraints) {
        ...
        AudioHelper2.prototype.setInputDevice = function(deviceId) {
          this._log.debug(".setInputDevice", deviceId);
          return this._setInputDevice(deviceId, false);
        };
        AudioHelper2.prototype.unsetAudioConstraints = function() {
          this._log.debug(".unsetAudioConstraints");
          this._audioConstraints = null;
          return this.inputDevice ? this._setInputDevice(this.inputDevice.deviceId, true) : Promise.resolve();
        };
        AudioHelper2.prototype.unsetInputDevice = function() {
          var _this = this;
        ...
        AudioHelper2.prototype._destroyProcessedStream = function() {
        ...
        AudioHelper2.prototype._getUnknownDeviceIndex = function(mediaDeviceInfo) {
        ...
        AudioHelper2.prototype._initializeEnumeration = function() {
          var _this = this;
        ...
        AudioHelper2.prototype._maybeCreateProcessedStream = function(stream) {
          var _this = this;
          if (this._processor) {
        ...
        AudioHelper2.prototype._maybeEnableSound = function(soundName, doEnable) {
          if (typeof doEnable !== "undefined") {
            this._enabledSounds[soundName] = doEnable;
          }
          return this._enabledSounds[soundName];
        };
        AudioHelper2.prototype._replaceStream = function(stream) {
        ...
        AudioHelper2.prototype._restartStreams = function() {
        ...
        AudioHelper2.prototype._setInputDevice = function(deviceId, forceGetUserMedia) {
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
              setInputDevice = function() {
                return __awaiter(_this, void 0, void 0, function() {
                  ...
                  return __generator(this, function(_a2) {
                    switch (_a2.label) {
                      case 0:
                        return [4, this._beforeSetInputDevice()];
                      case 1:
                        _a2.sent();
                        if (typeof deviceId !== "string") {
                          return [2, Promise.reject(new errors_1.InvalidArgumentError("Must specify the device to set"))];
                        }
                        device = this.availableInputDevices.get(deviceId);
                        if (!device) {
                          return [2, Promise.reject(new errors_1.InvalidArgumentError("Device not found: ".concat(deviceId)))];
                        }
                        ...
                        return [2, this._getUserMedia(constraints).then(function(originalStream) {
                          _this2._destroyProcessedStream();
                          return _this2._maybeCreateProcessedStream(originalStream).then(function(newStream) {
                            _this2._log.info("setInputDevice: invoking _onActiveInputChanged.");
                            return _this2._onActiveInputChanged(newStream).then(function() {
                              _this2._replaceStream(originalStream);
                              _this2._inputDevice = device;
                              _this2._maybeStartPollingVolume();
                            });
                          });
                        })];
                    }
              ...
              return [2, this._inputDevicePromise = setInputDevice().finally(function() {
                _this._inputDevicePromise = null;
              })];
            });
          });
        };
        AudioHelper2.prototype._stopMicrophonePermissionListener = function() {
          var _a;
        ...
        AudioHelper2.prototype._stopSelectedInputDeviceStream = function() {
          if (this._selectedInputDeviceStream) {
        ...
        AudioHelper2.prototype._updateDevices = function(updatedDevices, availableDevices, removeLostDevice) {
          var _this = this;
        ...
        AudioHelper2.prototype._updateVolumeSource = function() {
        ...
        AudioHelper2.prototype._wrapMediaDeviceInfo = function(mediaDeviceInfo) {
          var options = {
...
// node_modules/@twilio/voice-sdk/es5/twilio/audioprocessoreventobserver.js
var require_audioprocessoreventobserver = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/audioprocessoreventobserver.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ (function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var events_1 = require_events();
    var log_1 = require_log();
    var AudioProcessorEventObserver = (
      /** @class */
      (function(_super) {
        __extends(AudioProcessorEventObserver2, _super);
        function AudioProcessorEventObserver2() {
          var _this = _super.call(this) || this;
        ...
        AudioProcessorEventObserver2.prototype.destroy = function() {
          this.removeAllListeners();
        };
        AudioProcessorEventObserver2.prototype._reEmitEvent = function(name) {
          this._log.info("AudioProcessor:".concat(name));
          this.emit("event", { name, group: "audio-processor" });
        };
        return AudioProcessorEventObserver2;
      })(events_1.EventEmitter)
    );
...
// node_modules/@twilio/voice-sdk/es5/twilio/dialtonePlayer.js
var require_dialtonePlayer = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/dialtonePlayer.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var errors_1 = require_errors();
    var bandFrequencies = {
    ...
    var DialtonePlayer = (
      /** @class */
      (function() {
        function DialtonePlayer2(_context) {
          var _this = this;
        ...
        DialtonePlayer2.prototype.cleanup = function() {
          this._gainNodes.forEach(function(gainNode) {
            gainNode.disconnect();
          });
        };
        DialtonePlayer2.prototype.play = function(sound) {
          var _this = this;
...
// node_modules/@twilio/voice-sdk/es5/twilio/request.js
var require_request = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/request.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function request(method, params, callback) {
      ...
      fetch(params.url, { body, headers, method }).then(function(response) {
...
// node_modules/@twilio/voice-sdk/es5/twilio/eventpublisher.js
var require_eventpublisher = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/eventpublisher.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ (function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var EventPublisher = (
      /** @class */
      (function(_super) {
        __extends(EventPublisher2, _super);
        function EventPublisher2(productName, token, options) {
          var _this = _super.call(this) || this;
          if (!(_this instanceof EventPublisher2)) {
            return new EventPublisher2(productName, token, options);
          }
          options = Object.assign({ defaultPayload: function() {
            return {};
          } }, options);
          ...
          var isEnabled = true;
          var metadata = Object.assign({ app_name: void 0, app_version: void 0 }, options.metadata);
          Object.defineProperties(_this, {
...
// node_modules/@twilio/voice-sdk/es5/twilio/rtc/mockrtcstatsreport.js
var require_mockrtcstatsreport = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/rtc/mockrtcstatsreport.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    MockRTCStatsReport.fromRTCStatsResponse = function fromRTCStatsResponse(statsResponse) {
      ...
      var transportIds = /* @__PURE__ */ new Map();
...
// node_modules/@twilio/voice-sdk/es5/twilio/rtc/stats.js
var require_stats = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/rtc/stats.js"(exports) {
    "use strict";
    var __spreadArray = exports && exports.__spreadArray || function(to, from, pack) {
      if (pack || arguments.length === 2) for (var i = 0, l = from.length, ar; i < l; i++) {
        if (ar || !(i in from)) {
    ...
    var errors_1 = require_errors();
    var mockrtcstatsreport_1 = require_mockrtcstatsreport();
...
// node_modules/@twilio/voice-sdk/es5/twilio/preflight/preflight.js
var require_preflight = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/preflight/preflight.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ (function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var PreflightTest = (
      ...
      (function(_super) {
        ...
        function PreflightTest2(token, options) {
          ...
          _this._status = PreflightTest2.Status.Connecting;
          Object.assign(_this._options, options);
          _this._samples = [];
          _this._warnings = [];
          _this._startTime = Date.now();
          _this._initDevice(token, __assign(__assign({}, _this._options), { fileInputStream: _this._options.fakeMicInput ? _this._getStreamFromFile() : void 0 }));
          var userOptions = [
            "codecPreferences",
            "edge",
            "fakeMicInput",
        ...
        PreflightTest2.prototype._emitWarning = function(name, description, rtcWarning) {
          var warning = { name, description };
          if (rtcWarning) {
            warning.rtcWarning = rtcWarning;
          }
          this._warnings.push(warning);
          this._log.debug("#".concat(PreflightTest2.Events.Warning), JSON.stringify(warning));
          this.emit(PreflightTest2.Events.Warning, warning);
        };
        PreflightTest2.prototype._getCallQuality = function(mos) {
          if (mos > 4.2) {
            return PreflightTest2.CallQuality.Excellent;
          } else if (mos >= 4.1 && mos <= 4.2) {
            return PreflightTest2.CallQuality.Great;
          } else if (mos >= 3.7 && mos <= 4) {
            return PreflightTest2.CallQuality.Good;
          } else if (mos >= 3.1 && mos <= 3.6) {
            return PreflightTest2.CallQuality.Fair;
          } else {
            return PreflightTest2.CallQuality.Degraded;
          }
        };
        PreflightTest2.prototype._getReport = function() {
          var _a, _b, _c;
        ...
        PreflightTest2.prototype._getRTCSampleTotals = function() {
          if (!this._latestSample) {
            return;
          }
          return __assign({}, this._latestSample.totals);
        };
        PreflightTest2.prototype._getRTCStats = function() {
        ...
        PreflightTest2.prototype._getStreamFromFile = function() {
        ...
        PreflightTest2.prototype._initDevice = function(token, options) {
          var _this = this;
          try {
        ...
        PreflightTest2.prototype._onDeviceError = function(error) {
          this._device.destroy();
          this._onFailed(error);
        };
        PreflightTest2.prototype._onDeviceRegistered = function() {
          return __awaiter(this, void 0, void 0, function() {
        ...
        PreflightTest2.prototype._onFailed = function(error) {
          clearTimeout(this._echoTimer);
          clearTimeout(this._signalingTimeoutTimer);
          this._releaseHandlers();
          this._endTime = Date.now();
          this._status = PreflightTest2.Status.Failed;
          this._log.debug("#".concat(PreflightTest2.Events.Failed), error);
          this.emit(PreflightTest2.Events.Failed, error);
        };
        PreflightTest2.prototype._onUnregistered = function() {
          var _this = this;
          setTimeout(function() {
            if (_this._status === PreflightTest2.Status.Failed) {
              return;
            }
            ...
            _this._status = PreflightTest2.Status.Completed;
            _this._report = _this._getReport();
            _this._log.debug("#".concat(PreflightTest2.Events.Completed), JSON.stringify(_this._report));
            _this.emit(PreflightTest2.Events.Completed, _this._report);
          }, 10);
        };
        PreflightTest2.prototype._releaseHandlers = function() {
        ...
        PreflightTest2.prototype._setupCallHandlers = function(call) {
          var _this = this;
          if (this._options.fakeMicInput) {
          ...
          call.once("accept", function() {
            ...
            _this._status = PreflightTest2.Status.Connected;
            _this._log.debug("#".concat(PreflightTest2.Events.Connected));
            _this.emit(PreflightTest2.Events.Connected);
          });
              ...
              return __generator(this, function(_b) {
                switch (_b.label) {
                  case 0:
                    ...
                    _a = this;
                    return [4, (this._options.getRTCIceCandidateStatsReport || stats_1.getRTCIceCandidateStatsReport)(call["_mediaHandler"].version.pc)];
                  case 1:
                  ...
                  case 2:
                    ...
                    this._log.debug("#".concat(PreflightTest2.Events.Sample), JSON.stringify(sample));
                    this.emit(PreflightTest2.Events.Sample, sample);
                    return [
                      2
                      /*return*/
                    ];
          ...
          [{
            ...
            call["_mediaHandler"][handlerName] = function(state) {
              var timing = _this._networkTiming[reportLabel] = _this._networkTiming[reportLabel] || { start: 0 };
        ...
        Object.defineProperty(PreflightTest2.prototype, "callSid", {
          /**
        ...
        Object.defineProperty(PreflightTest2.prototype, "endTime", {
          /**
        ...
        Object.defineProperty(PreflightTest2.prototype, "latestSample", {
          /**
        ...
        Object.defineProperty(PreflightTest2.prototype, "report", {
          /**
        ...
        Object.defineProperty(PreflightTest2.prototype, "startTime", {
          /**
        ...
        Object.defineProperty(PreflightTest2.prototype, "status", {
          /**
    ...
    (function(PreflightTest2) {
      var CallQuality;
      (function(CallQuality2) {
        CallQuality2["Excellent"] = "excellent";
        CallQuality2["Great"] = "great";
        CallQuality2["Good"] = "good";
        CallQuality2["Fair"] = "fair";
        CallQuality2["Degraded"] = "degraded";
      })(CallQuality = PreflightTest2.CallQuality || (PreflightTest2.CallQuality = {}));
      var Events;
      (function(Events2) {
        Events2["Completed"] = "completed";
        Events2["Connected"] = "connected";
        Events2["Failed"] = "failed";
        Events2["Sample"] = "sample";
        Events2["Warning"] = "warning";
      })(Events = PreflightTest2.Events || (PreflightTest2.Events = {}));
      var Status;
      (function(Status2) {
      ...
      })(Status = PreflightTest2.Status || (PreflightTest2.Status = {}));
    })(PreflightTest || (exports.PreflightTest = PreflightTest = {}));
  }
});

// node_modules/@twilio/voice-sdk/es5/twilio/wstransport.js
var require_wstransport = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/wstransport.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ (function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var WSTransport = (
      /** @class */
      (function(_super) {
        __extends(WSTransport2, _super);
        function WSTransport2(uris, options) {
          if (options === void 0) {
            options = {};
          }
          var _this = _super.call(this) || this;
          ...
          _this._options = __assign(__assign({}, WSTransport2.defaultConstructorOptions), options);
          _this._uris = uris;
          _this._backoff = _this._setupBackoffs();
          return _this;
        }
        WSTransport2.prototype.close = function() {
          this._log.info("WSTransport.close() called...");
          this._close();
        };
        WSTransport2.prototype.open = function() {
        ...
        WSTransport2.prototype.send = function(message) {
        ...
        WSTransport2.prototype.updatePreferredURI = function(uri) {
          this._preferredUri = uri;
        };
        WSTransport2.prototype.updateURIs = function(uris) {
        ...
        WSTransport2.prototype._close = function() {
          this._setState(WSTransportState.Closed);
          this._closeSocket();
        };
        WSTransport2.prototype._closeSocket = function() {
        ...
        WSTransport2.prototype._connect = function(uri, retryCount) {
          var _this = this;
          this._log.info(typeof retryCount === "number" ? "Attempting to reconnect (retry #".concat(retryCount, ")...") : "Attempting to connect...");
          this._closeSocket();
        ...
        WSTransport2.prototype._performBackoff = function() {
          if (this._preferredUri) {
        ...
        WSTransport2.prototype._resetBackoffs = function() {
        ...
        WSTransport2.prototype._setHeartbeatTimeout = function() {
          var _this = this;
          clearTimeout(this._heartbeatTimeout);
          this._heartbeatTimeout = setTimeout(function() {
            _this._log.info("No messages received in ".concat(HEARTBEAT_TIMEOUT / 1e3, " seconds. Reconnecting..."));
            _this._shouldFallback = true;
            _this._closeSocket();
          }, HEARTBEAT_TIMEOUT);
        };
        WSTransport2.prototype._setState = function(state) {
          this._previousState = this.state;
          this.state = state;
        };
        WSTransport2.prototype._setupBackoffs = function() {
          var _this = this;
        ...
        Object.defineProperty(WSTransport2.prototype, "uri", {
          /**
        ...
        WSTransport2.defaultConstructorOptions = {
          WebSocket,
...
// node_modules/@twilio/voice-sdk/es5/twilio/pstream.js
var require_pstream = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/pstream.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ (function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var errors_1 = require_errors();
    var log_1 = require_log();
    var wstransport_1 = require_wstransport();
    var PSTREAM_VERSION = "1.6";
    var MAX_RECONNECT_TIMEOUT_ALLOWED = 30;
    var PStream = (
      /** @class */
      (function(_super) {
        __extends(PStream2, _super);
        function PStream2(token, uris, options) {
          var _this = _super.call(this) || this;
          if (!(_this instanceof PStream2)) {
            return new PStream2(token, uris, options);
          }
          var defaults = {
    ...
    PStream.prototype.hangup = function(callsid, message) {
      var payload = message ? { callsid, message } : { callsid };
...
// node_modules/@twilio/voice-sdk/es5/twilio/regions.js
var require_regions = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/regions.js"(exports) {
    "use strict";
    var _a;
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function createEventGatewayURI(region) {
      return region ? "eventgw.".concat(region, ".twilio.com") : defaultEventGatewayURI;
    }
...
// node_modules/@twilio/voice-sdk/es5/twilio/rtc/sdp.js
var require_sdp = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/rtc/sdp.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function setMaxAverageBitrate(sdp, maxAverageBitrate) {
      ...
      var lines = sdp.split("\n").map(function(line) {
        return regex.test(line) ? line + ";maxaveragebitrate=".concat(maxAverageBitrate) : line;
      });
      return lines.join("\n");
    }
...
// node_modules/@twilio/voice-sdk/es5/twilio/rtc/rtcpc.js
var require_rtcpc = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/rtc/rtcpc.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var log_1 = require_log();
    var util = require_util();
    var sdp_1 = require_sdp();
    ...
    RTCPC.prototype.processSDP = function(maxAverageBitrate, codecPreferences, sdp, constraints, onSuccess, onError) {
      ...
      var desc = new RTCSessionDescription({ sdp, type: "offer" });
...
// node_modules/@twilio/voice-sdk/es5/twilio/rtc/peerconnection.js
var require_peerconnection = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/rtc/peerconnection.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var errors_1 = require_errors();
    var log_1 = require_log();
    var util = require_util();
    var rtcpc_1 = require_rtcpc();
    var sdp_1 = require_sdp();
    ...
    function PeerConnection(audioHelper, pstream, options) {
      ...
      this.callSid = null;
      this.isMuted = false;
      var AudioContext2 = typeof window !== "undefined" && (window.AudioContext || window.webkitAudioContext);
      ...
      this.version.createOffer(this.options.maxAverageBitrate, { iceRestart: true }).then(function() {
        ...
        _this._onAnswerOrRinging = function(payload) {
          ...
          if (!payload.sdp || _this.version.pc.signalingState !== "have-local-offer") {
            var message = "Invalid state or param during ICE Restart:" + "hasSdp:".concat(!!payload.sdp, ", signalingState:").concat(_this.version.pc.signalingState);
          ...
          if (_this.status !== "closed") {
            _this.version.processAnswer(_this.codecPreferences, sdp, null, function(err) {
              var message2 = err && err.message ? err.message : err;
              _this._log.error("Failed to process answer during ICE Restart. Error: ".concat(message2));
            });
          }
        };
...
// node_modules/@twilio/voice-sdk/es5/twilio/rtc/index.js
var require_rtc = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/rtc/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.PeerConnection = void 0;
    exports.enabled = enabled;
    exports.getMediaEngine = getMediaEngine;
    var peerconnection_1 = require_peerconnection();
...
// node_modules/@twilio/voice-sdk/es5/twilio/rtc/getusermedia.js
var require_getusermedia = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/rtc/getusermedia.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var errors_1 = require_errors();
    var util = require_util();
    function getUserMedia(constraints, options) {
      ...
      return new Promise(function(resolve, reject) {
        ...
        throw options.util.isFirefox() && e.name === "NotReadableError" ? new errors_1.NotSupportedError("Firefox does not currently support opening multiple audio input trackssimultaneously, even across different tabs.\nRelated Bugzilla thread: https://bugzilla.mozilla.org/show_bug.cgi?id=1299324") : e;
      });
    }
...
// node_modules/@twilio/voice-sdk/es5/twilio/sid.js
var require_sid = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/sid.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function generateRandomizedString() {
      ...
      if (typeof crypto.getRandomValues !== "function") {
        throw new errors_1.NotSupportedError("The function `crypto.getRandomValues` is not available on this platform.");
      }
      ...
      return crypto.getRandomValues(new window.Uint8Array(16)).reduce(function(r, n) {
        return "".concat(r).concat(n.toString(16).padStart(2, "0"));
      }, "");
    }
...
// node_modules/@twilio/voice-sdk/es5/twilio/deferred.js
var require_deferred = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/deferred.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Deferred = (
      /** @class */
...
// node_modules/@twilio/voice-sdk/es5/twilio/asyncQueue.js
var require_asyncQueue = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/asyncQueue.js"(exports) {
    "use strict";
    var __awaiter = exports && exports.__awaiter || function(thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
    ...
    var AsyncQueue = (
      ...
      (function() {
        ...
        AsyncQueue2.prototype.enqueue = function(callback) {
        ...
        AsyncQueue2.prototype._processQueue = function() {
          return __awaiter(this, void 0, void 0, function() {
...
// node_modules/@twilio/voice-sdk/es5/twilio/audioplayer/deferred.js
var require_deferred2 = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/audioplayer/deferred.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Deferred = (
      /** @class */
...
// node_modules/@twilio/voice-sdk/es5/twilio/audioplayer/eventtarget.js
var require_eventtarget = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/audioplayer/eventtarget.js"(exports) {
    "use strict";
    var __spreadArray = exports && exports.__spreadArray || function(to, from, pack) {
      if (pack || arguments.length === 2) for (var i = 0, l = from.length, ar; i < l; i++) {
        if (ar || !(i in from)) {
    ...
    var EventTarget = (
      ...
      (function() {
        ...
        EventTarget2.prototype.addEventListener = function(name, handler) {
          return this._eventEmitter.addListener(name, handler);
        };
        EventTarget2.prototype.dispatchEvent = function(name) {
          var _a;
          var args = [];
        ...
        EventTarget2.prototype.removeEventListener = function(name, handler) {
...
// node_modules/@twilio/voice-sdk/es5/twilio/audioplayer/audioplayer.js
var require_audioplayer = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/audioplayer/audioplayer.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ (function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    var deferred_1 = require_deferred2();
    var eventtarget_1 = require_eventtarget();
    var AudioPlayer = (
      /** @class */
      (function(_super) {
        __extends(AudioPlayer2, _super);
        function AudioPlayer2(audioContext, srcOrOptions, options) {
        ...
        Object.defineProperty(AudioPlayer2.prototype, "destination", {
          get: function() {
        ...
        Object.defineProperty(AudioPlayer2.prototype, "loop", {
          get: function() {
            return this._loop;
          },
        ...
        Object.defineProperty(AudioPlayer2.prototype, "muted", {
          /**
        ...
        Object.defineProperty(AudioPlayer2.prototype, "paused", {
          /**
        ...
        Object.defineProperty(AudioPlayer2.prototype, "src", {
          get: function() {
            return this._src;
          },
          set: function(src) {
        ...
        Object.defineProperty(AudioPlayer2.prototype, "srcObject", {
          /**
        ...
        Object.defineProperty(AudioPlayer2.prototype, "sinkId", {
          get: function() {
            return this._sinkId;
          },
          enumerable: false,
        ...
        AudioPlayer2.prototype.load = function() {
          this._load(this._src);
        };
        AudioPlayer2.prototype.pause = function() {
          if (this.paused) {
            return;
          }
        ...
        AudioPlayer2.prototype.play = function() {
          return __awaiter(this, void 0, void 0, function() {
            var buffer;
            var _this = this;
            return __generator(this, function(_a) {
              switch (_a.label) {
                case 0:
                  if (!!this.paused) return [3, 2];
                  return [4, this._bufferPromise];
                case 1:
                  _a.sent();
                  if (!this.paused) {
                    return [
                ...
                case 3:
                  ...
                  if (this._audioElement.srcObject) {
                    return [2, this._audioElement.play()];
                  }
                  return [
                    2
                    /*return*/
        ...
        AudioPlayer2.prototype.setSinkId = function(sinkId) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
              switch (_a.label) {
                case 0:
                  ...
                  return [4, this._audioElement.setSinkId(sinkId)];
                case 1:
                  _a.sent();
                  if (this._audioElement.srcObject) {
                    return [
        ...
        AudioPlayer2.prototype._createPlayDeferred = function() {
          var deferred = new deferred_1.default();
          this._pendingPlayDeferreds.push(deferred);
          return deferred;
        };
        AudioPlayer2.prototype._load = function(src) {
          var _this = this;
            ...
            return __awaiter(_this, void 0, void 0, function() {
              ...
              return __generator(this, function(_a) {
                switch (_a.label) {
                  case 0:
                    if (!src) {
                      return [2, this._createPlayDeferred().promise];
                    }
                    return [4, bufferSound(this._audioContext, this._XMLHttpRequest, src)];
                  case 1:
                    buffer = _a.sent();
        ...
        AudioPlayer2.prototype._rejectPlayDeferreds = function(reason) {
        ...
        AudioPlayer2.prototype._resolvePlayDeferreds = function(result) {
          var deferreds = this._pendingPlayDeferreds;
          deferreds.splice(0, deferreds.length).forEach(function(_a) {
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            ...
            case 1:
              event = _a.sent();
              try {
                return [2, context.decodeAudioData(event.target.response)];
              } catch (e) {
...
// node_modules/@twilio/voice-sdk/es5/twilio/sound.js
var require_sound = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/sound.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var asyncQueue_1 = require_asyncQueue();
    var audioplayer_1 = require_audioplayer();
    var errors_1 = require_errors();
...
// node_modules/@twilio/voice-sdk/es5/twilio/device.js
var require_device = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/device.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ (function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var audiohelper_1 = require_audiohelper();
    var audioprocessoreventobserver_1 = require_audioprocessoreventobserver();
    var call_1 = require_call();
    var C = require_constants();
    var dialtonePlayer_1 = require_dialtonePlayer();
    var errors_1 = require_errors();
    var eventpublisher_1 = require_eventpublisher();
    var log_1 = require_log();
    var preflight_1 = require_preflight();
    var pstream_1 = require_pstream();
    var regions_1 = require_regions();
    var rtc = require_rtc();
    var getusermedia_1 = require_getusermedia();
    var sid_1 = require_sid();
    ...
    var Device = (
      /** @class */
      (function(_super) {
        __extends(Device2, _super);
        function Device2(token, options) {
          var _a;
          if (options === void 0) {
            options = {};
          }
          ...
          _this._soundcache = /* @__PURE__ */ new Map();
          _this._state = Device2.State.Unregistered;
          _this._stateEventMapping = (_a = {}, _a[Device2.State.Destroyed] = Device2.EventName.Destroyed, _a[Device2.State.Unregistered] = Device2.EventName.Unregistered, _a[Device2.State.Registering] = Device2.EventName.Registering, _a[Device2.State.Registered] = Device2.EventName.Registered, _a);
          _this._stream = null;
          ...
          _this._onSignalingConnected = function(payload) {
            ...
            (_a2 = _this._publisher) === null || _a2 === void 0 ? void 0 : _a2.setHost((0, regions_1.createEventGatewayURI)(payload.home));
            if (payload.token) {
              _this._identity = payload.token.identity;
              if (typeof payload.token.ttl === "number" && typeof _this._options.tokenRefreshMs === "number") {
                var ttlMs = payload.token.ttl * 1e3;
          ...
          _this._onSignalingError = function(payload) {
            ...
            if (typeof originalError !== "object" || !!voiceeventsid) {
              _this._log.warn("Ignoring signaling error payload", { originalError, voiceeventsid });
              return;
            }
            var call = typeof callsid === "string" && _this._findCall(callsid) || void 0;
            ...
            _this.emit(Device2.EventName.Error, twilioError, call);
          };
                ...
                switch (_b.label) {
                  case 0:
                    ...
                    if (!payload.callsid || !payload.sdp) {
                      ...
                      this.emit(Device2.EventName.Error, new errors_1.ClientErrors.BadRequest("Malformed invite from gateway"));
                      return [
                        2
                        /*return*/
                      ];
                  ...
                  case 1:
                    _b.trys.push([1, , 3, 4]);
                    return [4, this._makeCallPromise];
                  case 2:
                    call = _b.sent();
                    return [3, 4];
                  case 3:
                  ...
                  case 4:
                    ...
                    call.once("accept", function() {
                      _this2._soundcache.get(Device2.SoundName.Incoming).stop();
                      _this2._publishNetworkChange();
                    });
                    play = ((_a2 = this._audio) === null || _a2 === void 0 ? void 0 : _a2.incoming()) && !wasBusy ? function() {
                      return _this2._soundcache.get(Device2.SoundName.Incoming).play();
                    } : function() {
                      return Promise.resolve();
                    };
          ...
          _this._onSignalingOffline = function() {
            ...
            _this._edge = null;
            _this._region = null;
            _this._shouldReRegister = _this.state !== Device2.State.Unregistered;
            _this._setState(Device2.State.Unregistered);
          };
          _this._onSignalingReady = function() {
            _this._log.info("Stream is ready");
            _this._setState(Device2.State.Registered);
          };
          ...
          if (!Device2.isSupported && options.ignoreBrowserSupport) {
          ...
          Device2._getOrCreateAudioContext();
          if (Device2._audioContext) {
            if (!Device2._dialtonePlayer) {
              Device2._dialtonePlayer = new dialtonePlayer_1.default(Device2._audioContext);
            }
          }
          if (typeof Device2._isUnifiedPlanDefault === "undefined") {
            Device2._isUnifiedPlanDefault = typeof window !== "undefined" && typeof RTCPeerConnection !== "undefined" && typeof RTCRtpTransceiver !== "undefined" ? (0, util_1.isUnifiedPlanDefault)(window, window.navigator, RTCPeerConnection, RTCRtpTransceiver) : false;
          }
        ...
        Object.defineProperty(Device2, "audioContext", {
          /**
           * The AudioContext to be used by {@link Device} instances.
           * @private
           */
          get: function() {
            return Device2._audioContext;
          },
          enumerable: false,
          configurable: true
        });
        Object.defineProperty(Device2, "extension", {
          /**
           * Which sound file extension is supported.
           * @private
           */
          get: function() {
            var a = typeof document !== "undefined" ? document.createElement("audio") : { canPlayType: false };
            var canPlayMp3;
            try {
        ...
        Object.defineProperty(Device2, "isSupported", {
          /**
        ...
        Object.defineProperty(Device2, "packageName", {
          /**
        ...
        Device2.runPreflight = function(token, options) {
          return new preflight_1.PreflightTest(token, __assign({ audioContext: Device2._getOrCreateAudioContext() }, options));
        };
        Device2.toString = function() {
          return "[Twilio.Device class]";
        };
        Object.defineProperty(Device2, "version", {
          /**
           * Current SDK version.
           */
          get: function() {
        ...
        Device2._getOrCreateAudioContext = function() {
          if (!Device2._audioContext) {
            if (typeof AudioContext !== "undefined") {
              Device2._audioContext = new AudioContext();
            } else if (typeof webkitAudioContext !== "undefined") {
              Device2._audioContext = new webkitAudioContext();
            }
          }
          return Device2._audioContext;
        };
        Object.defineProperty(Device2.prototype, "audio", {
          /**
        ...
        Device2.prototype.connect = function() {
            ...
            return __generator(this, function(_b) {
              switch (_b.label) {
                ...
                case 4:
                  ...
                  this._soundcache.get(Device2.SoundName.Incoming).stop();
        ...
        Object.defineProperty(Device2.prototype, "calls", {
          /**
        ...
        Device2.prototype.destroy = function() {
          var _a;
          ...
          this._setState(Device2.State.Destroyed);
          events_1.EventEmitter.prototype.removeAllListeners.call(this);
        };
        Device2.prototype.disconnectAll = function() {
        ...
        Object.defineProperty(Device2.prototype, "edge", {
          /**
        ...
        Object.defineProperty(Device2.prototype, "home", {
          /**
        ...
        Object.defineProperty(Device2.prototype, "identity", {
          /**
        ...
        Object.defineProperty(Device2.prototype, "isBusy", {
          /**
        ...
        Device2.prototype.register = function() {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
              switch (_a.label) {
                case 0:
                  this._log.debug(".register");
                  if (this.state !== Device2.State.Unregistered) {
                    throw new errors_1.InvalidStateError('Attempt to register when device is in state "'.concat(this.state, '". ') + 'Must be "'.concat(Device2.State.Unregistered, '".'));
                  }
                  this._shouldReRegister = false;
                  this._setState(Device2.State.Registering);
                  return [4, this._streamConnectedPromise || this._setupStream()];
                case 1:
                  _a.sent();
                  return [4, this._sendPresence(true)];
                case 2:
                  _a.sent();
                  return [4, (0, util_1.promisifyEvents)(this, Device2.State.Registered, Device2.State.Unregistered)];
                case 3:
                  _a.sent();
                  return [
                    2
        ...
        Object.defineProperty(Device2.prototype, "state", {
          /**
        ...
        Object.defineProperty(Device2.prototype, "token", {
          /**
        ...
        Device2.prototype.toString = function() {
          return "[Twilio.Device instance]";
        };
        Device2.prototype.unregister = function() {
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
              switch (_a.label) {
                case 0:
                  ...
                  if (this.state !== Device2.State.Registered) {
                    throw new errors_1.InvalidStateError('Attempt to unregister when device is in state "'.concat(this.state, '". ') + 'Must be "'.concat(Device2.State.Registered, '".'));
                  }
                  this._shouldReRegister = false;
        ...
        Device2.prototype.updateOptions = function(options) {
          if (options === void 0) {
            options = {};
          }
          this._logOptions("updateOptions", options);
          if (this.state === Device2.State.Destroyed) {
          ...
          for (var _a = 0, _b = Object.keys(Device2._defaultSounds); _a < _b.length; _a++) {
            var name_1 = _b[_a];
            var soundDef = Device2._defaultSounds[name_1];
            var defaultUrl = "".concat(C.SOUNDS_BASE_URL, "/").concat(soundDef.filename, ".").concat(Device2.extension) + "?cache=".concat(C.RELEASE_VERSION);
            ...
            var sound = new (this._options.Sound || sound_1.default)(name_1, soundUrl, {
              audioContext: this._options.disableAudioContextSounds ? null : Device2.audioContext,
        ...
        Device2.prototype.updateToken = function(token) {
        ...
        Device2.prototype._confirmClose = function(event) {
          if (!this._activeCall) {
            return "";
          }
        ...
        Device2.prototype._destroyAudioHelper = function() {
          if (!this._audio) {
            return;
          }
        ...
        Device2.prototype._destroyPublisher = function() {
          if (!this._publisher) {
            return;
          }
          this._publisher = null;
        };
        Device2.prototype._destroyStream = function() {
          if (this._stream) {
        ...
        Device2.prototype._logOptions = function(caller, options) {
          if (options === void 0) {
            options = {};
          }
          var userOptions = [
        ...
        Device2.prototype._makeCall = function(twimlParams_1, options_1) {
            ...
            return __generator(this, function(_c) {
              switch (_c.label) {
                case 0:
                  ...
                  if (!inputDevicePromise) return [3, 2];
                  this._log.debug("inputDevicePromise detected, waiting...");
                  return [4, inputDevicePromise];
                case 1:
                  _c.sent();
                ...
                case 2:
                  _a = {
                    ...
                    isUnifiedPlanDefault: Device2._isUnifiedPlanDefault,
                    onIgnore: function() {
                      _this._soundcache.get(Device2.SoundName.Incoming).stop();
                    }
                  };
                  return [4, this._streamConnectedPromise || this._setupStream()];
                case 3:
                  config = (_a.pstream = _c.sent(), _a.publisher = this._publisher, _a.soundcache = this._soundcache, _a);
                  options = Object.assign({
                    ...
                    dialtonePlayer: Device2._dialtonePlayer,
                    ...
                    shouldPlayDisconnect: function() {
                      var _a2;
                      return (_a2 = _this._audio) === null || _a2 === void 0 ? void 0 : _a2.disconnect();
                    },
                    twimlParams,
                    voiceEventSidGenerator: this._options.voiceEventSidGenerator
                  }, options);
                  ...
                  call.once("accept", function() {
                    ...
                    if (call.direction === call_1.default.CallDirection.Outgoing && ((_a2 = _this._audio) === null || _a2 === void 0 ? void 0 : _a2.outgoing()) && !isReconnect) {
                      _this._soundcache.get(Device2.SoundName.Outgoing).play();
                    }
                    ...
                    if ((_b2 = _this._audio) === null || _b2 === void 0 ? void 0 : _b2.processedStream) {
                      (_c2 = _this._audioProcessorEventObserver) === null || _c2 === void 0 ? void 0 : _c2.emit("enabled");
                    }
                  });
        ...
        Device2.prototype._maybeStopIncomingSound = function() {
          if (!this._calls.length) {
            this._soundcache.get(Device2.SoundName.Incoming).stop();
          }
        };
        Device2.prototype._removeCall = function(call) {
        ...
        Device2.prototype._sendPresence = function(presence) {
          return __awaiter(this, void 0, void 0, function() {
            var stream;
            return __generator(this, function(_a) {
              switch (_a.label) {
        ...
        Device2.prototype._setState = function(state) {
          if (state === this.state) {
            return;
          }
          this._state = state;
        ...
        Device2.prototype._setupAudioHelper = function() {
          var _this = this;
          ...
          var audioOptions = {
            audioContext: Device2.audioContext,
        ...
        Device2.prototype._setupLoglevel = function(logLevel) {
        ...
        Device2.prototype._setupPublisher = function() {
          var _this = this;
          if (this._publisher) {
        ...
        Device2.prototype._setupStream = function() {
          var _this = this;
          if (this._stream) {
          ...
          return this._streamConnectedPromise = (0, util_1.promisifyEvents)(this._stream, "connected", "close").then(function() {
            return _this._stream;
          });
        };
        Device2.prototype._showIncomingCall = function(call, play) {
          var _this = this;
          var timeout;
          return Promise.race([
            play(),
            ...
            _this.emit(Device2.EventName.Incoming, call);
          });
        };
        Device2.prototype._startRegistrationTimer = function() {
          var _this = this;
          this._stopRegistrationTimer();
        ...
        Device2.prototype._stopRegistrationTimer = function() {
          if (this._regTimer) {
            clearTimeout(this._regTimer);
          }
        };
        Device2.prototype._throwIfDestroyed = function() {
          if (this.state === Device2.State.Destroyed) {
            throw new errors_1.InvalidStateError("Device has been destroyed.");
          }
        };
        Device2.prototype._updateRingtoneSinkIds = function(sinkIds) {
          return Promise.resolve(this._soundcache.get(Device2.SoundName.Incoming).setSinkIds(sinkIds));
        };
        Device2.prototype._updateSpeakerSinkIds = function(sinkIds) {
          Array.from(this._soundcache.entries()).filter(function(entry) {
            return entry[0] !== Device2.SoundName.Incoming;
    ...
    (function(Device2) {
      var EventName;
      (function(EventName2) {
        EventName2["Error"] = "error";
        EventName2["Incoming"] = "incoming";
        EventName2["Destroyed"] = "destroyed";
        EventName2["Unregistered"] = "unregistered";
        EventName2["Registering"] = "registering";
        EventName2["Registered"] = "registered";
        EventName2["TokenWillExpire"] = "tokenWillExpire";
      })(EventName = Device2.EventName || (Device2.EventName = {}));
      var State;
      (function(State2) {
        State2["Destroyed"] = "destroyed";
        State2["Unregistered"] = "unregistered";
        State2["Registering"] = "registering";
        State2["Registered"] = "registered";
      })(State = Device2.State || (Device2.State = {}));
      var SoundName;
      (function(SoundName2) {
        SoundName2["Incoming"] = "incoming";
        SoundName2["Outgoing"] = "outgoing";
        SoundName2["Disconnect"] = "disconnect";
        SoundName2["Dtmf0"] = "dtmf0";
        SoundName2["Dtmf1"] = "dtmf1";
        SoundName2["Dtmf2"] = "dtmf2";
        SoundName2["Dtmf3"] = "dtmf3";
        SoundName2["Dtmf4"] = "dtmf4";
        SoundName2["Dtmf5"] = "dtmf5";
        SoundName2["Dtmf6"] = "dtmf6";
        SoundName2["Dtmf7"] = "dtmf7";
        SoundName2["Dtmf8"] = "dtmf8";
        SoundName2["Dtmf9"] = "dtmf9";
        SoundName2["DtmfS"] = "dtmfs";
        SoundName2["DtmfH"] = "dtmfh";
      })(SoundName = Device2.SoundName || (Device2.SoundName = {}));
    })(Device || (Device = {}));
    exports.default = Device;
  }
});

// node_modules/@twilio/voice-sdk/es5/twilio/rtc/icecandidate.js
var require_icecandidate = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/rtc/icecandidate.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var IceCandidate = (
      /** @class */
      (function() {
        function IceCandidate2(iceCandidate, isRemote) {
          if (isRemote === void 0) {
            isRemote = false;
          }
          this.deleted = false;
        ...
        IceCandidate2.prototype.toPayload = function() {
          return {
...
// node_modules/@twilio/voice-sdk/es5/twilio/rtc/mos.js
var require_mos = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/rtc/mos.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@twilio/voice-sdk/es5/twilio/statsMonitor.js
var require_statsMonitor = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/statsMonitor.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ (function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    function flattenSamples(sampleSets) {
      return sampleSets.reduce(function(flat, current) {
        return __spreadArray(__spreadArray([], flat, true), current, true);
      }, []);
    }
    var StatsMonitor = (
      /** @class */
      (function(_super) {
        __extends(StatsMonitor2, _super);
        function StatsMonitor2(options) {
          var _this = _super.call(this) || this;
          _this._activeWarnings = /* @__PURE__ */ new Map();
          _this._currentStreaks = /* @__PURE__ */ new Map();
          _this._inputVolumes = [];
        ...
        StatsMonitor2.prototype.addVolumes = function(inputVolume, outputVolume) {
          this._inputVolumes.push(inputVolume);
          this._outputVolumes.push(outputVolume);
        };
        StatsMonitor2.prototype.disable = function() {
        ...
        StatsMonitor2.prototype.disableWarnings = function() {
        ...
        StatsMonitor2.prototype.enable = function(peerConnection) {
          if (peerConnection) {
        ...
        StatsMonitor2.prototype.enableWarnings = function() {
          this._warningsEnabled = true;
          return this;
        };
        StatsMonitor2.prototype.hasActiveWarning = function(statName, thresholdName) {
          var warningId = "".concat(statName, ":").concat(thresholdName);
          return !!this._activeWarnings.get(warningId);
        };
        StatsMonitor2.prototype._addSample = function(sample) {
        ...
        StatsMonitor2.prototype._clearWarning = function(statName, thresholdName, data) {
          var warningId = "".concat(statName, ":").concat(thresholdName);
        ...
        StatsMonitor2.prototype._createSample = function(stats, previousSample) {
        ...
        StatsMonitor2.prototype._fetchSample = function() {
          var _this = this;
        ...
        StatsMonitor2.prototype._getSample = function() {
          var _this = this;
        ...
        StatsMonitor2.prototype._raiseWarning = function(statName, thresholdName, data) {
          var warningId = "".concat(statName, ":").concat(thresholdName);
        ...
        StatsMonitor2.prototype._raiseWarnings = function() {
          var _this = this;
          if (!this._warningsEnabled) {
            return;
          }
        ...
        StatsMonitor2.prototype._raiseWarningsForStat = function(statName) {
          var _this = this;
          ...
          limits.forEach(function(limit) {
            ...
            if (typeof limit.max === "number") {
              ...
              if (count >= raiseCount) {
                _this._raiseWarning(statName, "max", { values, samples: relevantSamples });
              } else if (count <= clearCount) {
                _this._clearWarning(statName, "max", { values, samples: relevantSamples });
              }
            }
            if (typeof limit.min === "number") {
              count = countLow(limit.min, values);
              if (count >= raiseCount) {
                _this._raiseWarning(statName, "min", { values, samples: relevantSamples });
              } else if (count <= clearCount) {
                _this._clearWarning(statName, "min", { values, samples: relevantSamples });
              }
            }
            ...
            [
              ...
              if (typeof limit[thresholdName] === "number" && values.length >= sampleCount) {
                ...
                if (comparator(avg, limit[thresholdName])) {
                  _this._raiseWarning(statName, thresholdName, { values, samples: relevantSamples });
                } else if (!comparator(avg, limit.clearValue || limit[thresholdName])) {
                  _this._clearWarning(statName, thresholdName, { values, samples: relevantSamples });
                }
              }
            });
          });
        };
        return StatsMonitor2;
      })(events_1.EventEmitter)
    );
...
// node_modules/@twilio/voice-sdk/es5/twilio/call.js
var require_call = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio/call.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ (function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var errors_1 = require_errors();
    var log_1 = require_log();
    var rtc_1 = require_rtc();
    var icecandidate_1 = require_icecandidate();
    var sdp_1 = require_sdp();
    var sid_1 = require_sid();
    var statsMonitor_1 = require_statsMonitor();
    var util_1 = require_util();
    var constants_1 = require_constants();
    var BACKOFF_CONFIG = {
      factor: 1.1,
    ...
    var Call = (
      /** @class */
      (function(_super) {
        __extends(Call2, _super);
        function Call2(config, options) {
          var _this = _super.call(this) || this;
          _this.parameters = {};
          ...
          _this._mediaStatus = Call2.State.Pending;
          _this._messages = /* @__PURE__ */ new Map();
          ...
          _this._signalingStatus = Call2.State.Pending;
          _this._soundcache = /* @__PURE__ */ new Map();
          _this._status = Call2.State.Pending;
          ...
          _this._onAnswer = function(payload) {
            ...
            if (_this._isAnswered && _this._status !== Call2.State.Reconnecting) {
              return;
            }
          ...
          _this._onCancel = function(payload) {
            ...
            if (_this.parameters.CallSid === callsid) {
              ...
              _this._status = Call2.State.Closed;
          ...
          _this._onHangup = function(payload) {
            if (_this.status() === Call2.State.Closed) {
              return;
            }
            ...
            if (payload.error) {
              ...
              var errorConstructor = (0, errors_1.getPreciseSignalingErrorByCode)(_this._options.enableImprovedSignalingErrorPrecision, code);
              var error = typeof errorConstructor !== "undefined" ? new errorConstructor(payload.error.message) : new errors_1.GeneralErrors.ConnectionError("Error sent from gateway in HANGUP", payload.error);
          ...
          _this._onMediaFailure = function(type) {
            var _a = Call2.MediaFailure, ConnectionDisconnected = _a.ConnectionDisconnected, ConnectionFailed = _a.ConnectionFailed, IceGatheringFailed = _a.IceGatheringFailed, LowBytes = _a.LowBytes;
            ...
            if (_this._mediaStatus === Call2.State.Reconnecting) {
              if (isEndOfIceCycle) {
            ...
            if (type === LowBytes && isIceDisconnected || type === ConnectionDisconnected && hasLowBytesWarning || isEndOfIceCycle) {
              ...
              _this._status = Call2.State.Reconnecting;
              _this._mediaStatus = Call2.State.Reconnecting;
          ...
          _this._onMediaReconnected = function() {
            ...
            _this._mediaStatus = Call2.State.Open;
            if (_this._signalingStatus === Call2.State.Open) {
              _this._publisher.info("connection", "reconnected", null, _this);
              _this._log.debug("#reconnected");
              _this.emit("reconnected");
              _this._status = Call2.State.Open;
            }
          };
          ...
          _this._onMessageSent = function(voiceEventSid) {
            ...
            var message2 = _this._messages.get(voiceEventSid);
            _this._messages.delete(voiceEventSid);
            _this._publisher.info("call-message", message2 === null || message2 === void 0 ? void 0 : message2.messageType, {
              content_type: message2 === null || message2 === void 0 ? void 0 : message2.contentType,
              event_type: "sent",
              voice_event_sid: voiceEventSid
            }, _this);
            _this._log.debug("#messageSent", JSON.stringify(message2));
            _this.emit("messageSent", message2);
          };
          _this._onRinging = function(payload) {
            _this._setCallSid(payload);
            if (_this._status !== Call2.State.Connecting && _this._status !== Call2.State.Ringing) {
              return;
            }
            var hasEarlyMedia = !!payload.sdp;
            _this._status = Call2.State.Ringing;
            _this._publisher.info("connection", "outgoing-ringing", { hasEarlyMedia }, _this);
          ...
          _this._onSignalingReconnected = function() {
            if (_this._signalingStatus !== Call2.State.Reconnecting) {
              return;
            }
            _this._log.info("Signaling Connection reestablished.");
            _this._signalingStatus = Call2.State.Open;
            if (_this._mediaStatus === Call2.State.Open) {
              _this._publisher.info("connection", "reconnected", null, _this);
              _this._log.debug("#reconnected");
              _this.emit("reconnected");
              _this._status = Call2.State.Open;
          ...
          _this._onTransportClose = function() {
            ...
            if (_this._signalingReconnectToken) {
              _this._status = Call2.State.Reconnecting;
              _this._signalingStatus = Call2.State.Reconnecting;
              _this._log.debug("#reconnecting");
              _this.emit("reconnecting", new errors_1.SignalingErrors.ConnectionDisconnected());
            } else {
              _this._status = Call2.State.Closed;
              _this._signalingStatus = Call2.State.Closed;
            }
          };
          ...
          _this._voiceEventSidGenerator = _this._options.voiceEventSidGenerator || sid_1.generateVoiceEventSid;
          _this._direction = _this.parameters.CallSid && !_this._options.reconnectCallSid ? Call2.CallDirection.Incoming : Call2.CallDirection.Outgoing;
          if (_this.parameters) {
            _this.callerInfo = _this.parameters.StirStatus ? { isVerified: _this.parameters.StirStatus === "TN-Validation-Passed-A" } : null;
          } else {
          ...
          if (_this._direction === Call2.CallDirection.Incoming) {
          ...
          monitor.on("warning", function(data, wasCleared) {
            if (data.name === "bytesSent" || data.name === "bytesReceived") {
              _this._onMediaFailure(Call2.MediaFailure.LowBytes);
            }
          ...
          _this._mediaHandler.onicegatheringfailure = function(type) {
            ...
            _this._onMediaFailure(Call2.MediaFailure.IceGatheringFailed);
          };
          ...
          _this._mediaHandler.ondisconnected = function(msg) {
            ...
            _this._onMediaFailure(Call2.MediaFailure.ConnectionDisconnected);
          };
          _this._mediaHandler.onfailed = function(msg) {
            _this._onMediaFailure(Call2.MediaFailure.ConnectionFailed);
          };
          _this._mediaHandler.onconnected = function() {
            if (_this._status === Call2.State.Reconnecting) {
          ...
          _this._mediaHandler.onopen = function() {
            if (_this._status === Call2.State.Open || _this._status === Call2.State.Reconnecting) {
              return;
            } else if (_this._status === Call2.State.Ringing || _this._status === Call2.State.Connecting) {
          ...
          _this._mediaHandler.onclose = function() {
            _this._status = Call2.State.Closed;
            if (_this._options.shouldPlayDisconnect && _this._options.shouldPlayDisconnect() && !_this._isCancelled && !_this._isRejected) {
        ...
        Object.defineProperty(Call2.prototype, "direction", {
          /**
        ...
        Object.defineProperty(Call2.prototype, "codec", {
          /**
        ...
        Object.defineProperty(Call2.prototype, "connectToken", {
          /**
          ...
          get: function() {
            ...
            var callSid = this.parameters && this.parameters.CallSid ? this.parameters.CallSid : void 0;
        ...
        Call2.prototype._setInputTracksFromStream = function(stream) {
          return this._mediaHandler.setInputTracksFromStream(stream);
        };
        Call2.prototype._setSinkIds = function(sinkIds) {
          return this._mediaHandler._setSinkIds(sinkIds);
        };
        Call2.prototype.accept = function(options) {
          var _this = this;
          this._log.debug(".accept", options);
          if (this._status !== Call2.State.Pending) {
          ...
          this._status = Call2.State.Connecting;
          var connect = function() {
            if (_this._status !== Call2.State.Connecting) {
              _this._cleanupEventListeners();
              _this._mediaHandler.close();
              return;
            }
            var onAnswer = function(pc) {
              var eventName = _this._direction === Call2.CallDirection.Incoming ? "accepted-by-local" : "accepted-by-remote";
        ...
        Call2.prototype.isMuted = function() {
          return this._mediaHandler.isMuted;
        };
        Call2.prototype.mute = function(shouldMute) {
        ...
        Call2.prototype.postFeedback = function(score, issue) {
          if (typeof score === "undefined" || score === null) {
            return this._postFeedbackDeclined();
          }
          if (!Object.values(Call2.FeedbackScore).includes(score)) {
            throw new errors_1.InvalidArgumentError("Feedback score must be one of: ".concat(Object.values(Call2.FeedbackScore)));
          }
          if (typeof issue !== "undefined" && issue !== null && !Object.values(Call2.FeedbackIssue).includes(issue)) {
            throw new errors_1.InvalidArgumentError("Feedback issue must be one of: ".concat(Object.values(Call2.FeedbackIssue)));
          }
        ...
        Call2.prototype.reject = function() {
        ...
        Call2.prototype.sendDigits = function(digits) {
          var _this = this;
        ...
        Call2.prototype.sendMessage = function(message) {
        ...
        Call2.prototype.status = function() {
          return this._status;
        };
        Call2.prototype._checkVolume = function(currentVolume, currentStreak, lastValue, direction) {
        ...
        Call2.prototype._cleanupEventListeners = function() {
          var _this = this;
        ...
        Call2.prototype._createMetricPayload = function() {
          var payload = {
        ...
        Call2.prototype._disconnect = function(message, wasRemote) {
          message = typeof message === "string" ? message : null;
          if (this._status !== Call2.State.Open && this._status !== Call2.State.Connecting && this._status !== Call2.State.Reconnecting && this._status !== Call2.State.Ringing) {
            return;
          }
        ...
        Call2.prototype._postFeedbackDeclined = function() {
          return this._publisher.info("feedback", "received-none", null, this, true);
        };
        Call2.prototype._publishMetrics = function() {
          var _this = this;
        ...
        Call2.prototype._setCallSid = function(payload) {
          var callSid = payload.callsid;
          if (!callSid) {
            return;
          }
    ...
    (function(Call2) {
      ...
      (function(State2) {
        ...
        State2["Ringing"] = "ringing";
      })(State = Call2.State || (Call2.State = {}));
      var FeedbackIssue;
      (function(FeedbackIssue2) {
        FeedbackIssue2["AudioLatency"] = "audio-latency";
        FeedbackIssue2["ChoppyAudio"] = "choppy-audio";
        FeedbackIssue2["DroppedCall"] = "dropped-call";
        FeedbackIssue2["Echo"] = "echo";
        FeedbackIssue2["NoisyCall"] = "noisy-call";
        FeedbackIssue2["OneWayAudio"] = "one-way-audio";
      })(FeedbackIssue = Call2.FeedbackIssue || (Call2.FeedbackIssue = {}));
      var FeedbackScore;
      (function(FeedbackScore2) {
        FeedbackScore2[FeedbackScore2["One"] = 1] = "One";
        FeedbackScore2[FeedbackScore2["Two"] = 2] = "Two";
        FeedbackScore2[FeedbackScore2["Three"] = 3] = "Three";
        FeedbackScore2[FeedbackScore2["Four"] = 4] = "Four";
        FeedbackScore2[FeedbackScore2["Five"] = 5] = "Five";
      })(FeedbackScore = Call2.FeedbackScore || (Call2.FeedbackScore = {}));
      var CallDirection;
      (function(CallDirection2) {
        CallDirection2["Incoming"] = "INCOMING";
        CallDirection2["Outgoing"] = "OUTGOING";
      })(CallDirection = Call2.CallDirection || (Call2.CallDirection = {}));
      var Codec;
      (function(Codec2) {
        Codec2["Opus"] = "opus";
        Codec2["PCMU"] = "pcmu";
      })(Codec = Call2.Codec || (Call2.Codec = {}));
      var IceGatheringFailureReason;
      (function(IceGatheringFailureReason2) {
        IceGatheringFailureReason2["None"] = "none";
        IceGatheringFailureReason2["Timeout"] = "timeout";
      })(IceGatheringFailureReason = Call2.IceGatheringFailureReason || (Call2.IceGatheringFailureReason = {}));
      var MediaFailure;
      (function(MediaFailure2) {
        MediaFailure2["ConnectionDisconnected"] = "ConnectionDisconnected";
        MediaFailure2["ConnectionFailed"] = "ConnectionFailed";
        MediaFailure2["IceGatheringFailed"] = "IceGatheringFailed";
        MediaFailure2["LowBytes"] = "LowBytes";
      })(MediaFailure = Call2.MediaFailure || (Call2.MediaFailure = {}));
    })(Call || (Call = {}));
...
// node_modules/@twilio/voice-sdk/es5/twilio.js
var require_twilio = __commonJS({
  "node_modules/@twilio/voice-sdk/es5/twilio.js"(exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var preflight_1 = require_preflight();
    Object.defineProperty(exports, "PreflightTest", { enumerable: true, get: function() {
      return preflight_1.PreflightTest;
    } });
    var TwilioError = require_errors();
    exports.TwilioError = TwilioError;
  }
});
export default require_twilio();
//# sourceMappingURL=@twilio_voice-sdk.js.map
